...
func adminRequest(client *http.Client, method string, teamName string, values url.Values, debug bool) (*adminResponse, error) {
	adminResponse := &adminResponse{}
	err := parseAdminResponse(client, method, teamName, values, adminResponse, debug)
	if err != nil {
		return nil, err
	}
