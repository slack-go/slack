...
// TeamDomainChangedEvent is sent if a team's domain has changed.
type TeamDomainChangedEvent struct {
	Type   string `json:"type"`
	URL    string `json:"url"`
	Domain string `json:"domain"`
	TeamID string `json:"team_id"`
...
const (
	...
	TeamDomainChanged = EventsAPIType("team_domain_change")
...
var EventsAPIInnerEventMapping = map[EventsAPIType]interface{}{
	...
	TeamDomainChanged:           TeamDomainChangedEvent{},
