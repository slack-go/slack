...
func middlewareConnecting(evt socketmode.Event) {
	fmt.Println("Connecting to Slack with Socket Mode...")
}

func middlewareConnectionError(evt socketmode.Event) {
	fmt.Println("Connection failed. Retrying later...")
}

func middlewareConnected(evt socketmode.Event) {
	fmt.Println("Connected to Slack with Socket Mode.")
}

func middlewareEventsAPI(evt socketmode.Event) {
...
func middlewareSlashCommand(evt socketmode.Event) {
...
func middlewareDefault(evt socketmode.Event) {
