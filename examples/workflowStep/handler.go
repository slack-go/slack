...
func handleInteraction(w http.ResponseWriter, r *http.Request) {
    ...
    case slack.InteractionTypeViewSubmission:
        ...
        err := saveUserSettingsForWorkflowStep(&w, message.WorkflowStep.WorkflowStepEditID, in, nil)
        if err != nil {
...
func saveUserSettingsForWorkflowStep(w *http.ResponseWriter, workflowStepEditID string, inputs *slack.WorkflowStepInputs, outputs *[]slack.WorkflowStepOutput) error {
