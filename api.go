...
func apiRequest(ctx context.Context, client HTTPRequester, path string, values url.Values, debug bool) (*APIResponseFull, error) {
...
func (api *Client) GetApiTestContext(ctx context.Context) (*APIResponseFull, error) {
	...
	response, err := apiRequest(ctx, api.httpclient, "api.test", values, api.debug)
	if err != nil {
		return nil, err
	}
	return response, nil
