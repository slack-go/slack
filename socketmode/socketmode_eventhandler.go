...
// Register the middleare function to use to handle an Event (from socketmode)
func (r *SocketmodeHandler) Handle(et EventType, f SocketmodeHandlerFunc) {
	r.EventMap[et] = append(r.EventMap[et], f)
}

// Register the middleare function to use to handle an Interaction
...
// Register the middleare function to use to handle an Event (from slackevents)
...
// Register the middleare function to use as a last resort
